...
public class IntentIntegrator {
	static final String filePath = "/sdcard/BarcodeScanner.apk"; 
  ...
  private AlertDialog showInstallDialog() {
	    AlertDialog.Builder downloadDialog = new AlertDialog.Builder(activity);
	    downloadDialog.setTitle("未发现扫描软件");
	    downloadDialog.setMessage("请安装扫描软件");
	    downloadDialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
	      @Override
